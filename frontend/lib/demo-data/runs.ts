...
export const initialRuns: Run[] = [
  {
    ...
    diagnostics: {
      ...
      diagnosticsSummary: "Strategy result is profitable but mixed because diagnostics warnings remain.",
      totalPnL: 1840,
      totalReturnPct: 18.4,
      risk: {
        maxDrawdown: 970,
        maxDrawdownPct: 9.7,
        drawdownStart: "2023-03-02T00:00:00Z",
        drawdownEnd: "2023-05-16T00:00:00Z",
        recoveryBars: 42,
      },
      trades: {
        tradeCount: 842,
      ...
      warnings: [
        {
          ...
          message: "Backtest performance is concentrated in uneven stability segments.",
          severity: "warning",
        },
      ],
    },
