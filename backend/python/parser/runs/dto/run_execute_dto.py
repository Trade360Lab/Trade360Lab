...
class RunDiagnosticsPayload(BaseModel):
    ...
    diagnostics_status: str = Field(serialization_alias="diagnosticsStatus")
    diagnostics_summary: str = Field(serialization_alias="diagnosticsSummary")
